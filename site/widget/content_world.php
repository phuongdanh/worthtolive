...
<div class="content_wrapper">
    <div class="col-md-6 content_left">
        <div class="first_art">
            <span><?php if(strlen($most_read[0]['news_title']) > 53){ echo substr($most_read[0]['news_title'], 0,53); }else{ echo $most_read[0]['news_title']; } ?>...</span><br/>
            ...
            <p><?php if(isset($most_read[0]['news_description'])){ echo $most_read[0]['news_description']; };?>
            </p>
        </div>
        <ul class="list_art">
            <?php $i = -1;
             foreach ($most_read as $news) { $i++; if($i == 0){     continue; }elseif($i == 7){     break;}
             ?>
                 <li>
                    <img src="<?php echo $news['news_image'];?>">
                    <span><a href="#"><?php if(strlen($news['news_title']) > 50){ echo substr($news['news_title'], 0,50); }else{ echo $news['news_title']; } ?> ...</a></span><br/>
