    ...
    <div class="col-md-4 col-sm-4 content_right">
        <div class="subcribe">
            ...
            <form id="signupForm">
                ...
                <input class="form-control" type="text" name="Your phone" placeholder="Username">
                <input class="form-control" type="file" name="avatar" >
                <input id="password"  class="form-control" type="password" name="password" placeholder="Your password">
                <input id="confirm_password" class="form-control" type="password" name="password" placeholder="Confirm password">
                <button  id="agree"  name="submit" class="btn btn-info">Subcribe</button>
            </form>
        </div>
    </div>
</div>