...
<div class="content_wrapper">
    <div class="col-md-6 content_left">
        <div class="first_art">
            ...
            <img src="<?php echo $pathforsite; ?>images/book1.jpg" style="width:100%;margin-top:10px;margin-bottom:10px;">
            <p>Antonin Scalia during his confirmation hearings in Washington in 1986. Credit Lana Harris/Associated Press
            </p>
        </div>
        <ul class="list_art">
            <li>
                <img src="<?php echo $pathforsite; ?>images/book2.jpg">
            ...
            <li>
                <img src="<?php echo $pathforsite; ?>images/book3.jpg">
                <span><a href="#">Senate G.O.P. Digs In for Fight Over Replacing Scalia</a></span><br/>
                <i>20:35 16/06/2015</i>
                <p>WASHINGTON — An epic Washington political battle took shape on Sunday after the death of Justice Antonin Scalia as Senate Republicans dug in and said they would refuse to act on any Supreme Court nomination by President Obama. But the White House vowed to select a nominee within weeks.
                </p>
            ...
            <li>
                <img src="<?php echo $pathforsite; ?>images/book4.jpg">
                <span><a href="#">Senate G.O.P. Digs In for Fight Over Replacing Scalia</a></span><br/>
                <i>20:35 16/06/2015</i>
                <p>WASHINGTON — An epic Washington political battle took shape on Sunday after the death of Justice Antonin Scalia as Senate Republicans dug in and said they would refuse to act on any Supreme Court nomination by President Obama. But the White House vowed to select a nominee within weeks.
                </p>
            ...
            <li>
                <img src="<?php echo $pathforsite; ?>images/book5.jpg">
                <span><a href="#">Senate G.O.P. Digs In for Fight Over Replacing Scalia</a></span><br/>
                <i>20:35 16/06/2015</i>
                <p>WASHINGTON — An epic Washington political battle took shape on Sunday after the death of Justice Antonin Scalia as Senate Republicans dug in and said they would refuse to act on any Supreme Court nomination by President Obama. But the White House vowed to select a nominee within weeks.
                </p>
            ...
            <li>
                <img src="<?php echo $pathforsite; ?>images/book6.jpg">
                <span><a href="#">Senate G.O.P. Digs In for Fight Over Replacing Scalia</a></span><br/>
                <i>20:35 16/06/2015</i>
                <p>WASHINGTON — An epic Washington political battle took shape on Sunday after the death of Justice Antonin Scalia as Senate Republicans dug in and said they would refuse to act on any Supreme Court nomination by President Obama. But the White House vowed to select a nominee within weeks.
                </p>
    ...
    <div class="col-md-2 content_mid">
        ...
        <ul class="list_art img">
            ...
            <hr>
            <li>
                <img src="<?php echo $pathforsite; ?>images/book7.jpg">
                <span><a href="#">Obama move white house</a></span>
            </li>
            <li>
                <img src="<?php echo $pathforsite; ?>images/book8.jpg">
                <span><a href="#">Obama move white house</a></span>
            </li>
            <li>
                <img src="<?php echo $pathforsite; ?>images/book14.jpg">
                <span><a href="#">Obama move white house</a></span>
            </li>
            <li>
                <img src="<?php echo $pathforsite; ?>images/book10.jpg">
                <span><a href="#">Obama move white house</a></span>
            </li>
            <img src="<?php echo $pathforsite; ?>images/more.png">
        </ul>
    ...
    <div class="col-md-4 content_right">
        ...
        <ul class="edit">
            ...
            <li class="col-md-12 col-sm-6">
                <img src="<?php echo $pathforsite; ?>images/book11.jpg" width="100%">
                <a href="#"><span class="title">Lorem ipsum dolor sit amet, consectetur</span></a>
            </li>
            <li class="col-md-12 col-sm-6">
                <img src="<?php echo $pathforsite; ?>images/book12.jpg" width="100%">
                <a href="#"><span class="title">Lorem ipsum dolor sit amet, consectetur</span></a>
            </li>
            <li class="col-md-12 col-sm-6">
                <img src="<?php echo $pathforsite; ?>images/book13.jpg" width="100%">
                <a href="#"><span class="title">Lorem ipsum dolor sit amet, consectetur</span></a>
            </li>
            <li class="col-md-12 col-sm-6">
                <img src="<?php echo $pathforsite; ?>images/book9.jpg" width="100%">
                <a href="#"><span class="title">Lorem ipsum dolor sit amet, consectetur</span></a>
            </li>
            <img src="<?php echo $pathforsite; ?>images/more.png">
        </ul>
